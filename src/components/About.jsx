    ...
    <div id='tentangkami' className='w-full py-[7rem] px-4 bg-white mt-12'>
      <div className='max-w-[1240px] mx-auto grid md:grid-cols-3 gap-8'>
          <div className='w-full shadow-xl flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300'>
              <img className='w-20 mx-auto mt-[-3rem] bg-white' src='https://i.postimg.cc/4nP86WMZ/profile-hafizh.png' alt="Profile Hafizh" />
              <h2 className='text-2xl font-bold text-center py-8'>Crew</h2>
              <p className='text-center text-4xl font-bold'>Muhammad Hafizh Dzaki</p>
              <div className='text-center font-medium'>
                  <p className='py-2 mx-8 mt-8'>Sepandai-pandainya tupai melompat, lama lama jadi bukit</p>
              </div>
            <div className="socmedDev flex justify-between md:w-[40%] my-6 px-6 py-3">
          ...
          <div className='w-full shadow-xl bg-gray-100 flex flex-col p-4 md:my-0 my-8 rounded-lg hover:scale-105 duration-300'>
              <img className='w-20 mx-auto mt-[-3rem] bg-transparent' src='https://i.postimg.cc/0KkVgSzL/profile-arif.jpg' alt="Profile Arif" />
              <h2 className='text-2xl font-bold text-center py-8'>Captain</h2>
              <p className='text-center text-4xl font-bold'>Arif Saputra</p>
              <div className='text-center font-medium'>
                  <p className='py-2 mx-8 mt-8'>Berharap adalah seni menyakiti diri sendiri</p>
              </div>
              <div className="socmedDev flex justify-between md:w-[40%] my-6 px-6 py-3">
          ...
          <div className='w-full shadow-xl flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300'>
              <img className='w-20 mx-auto mt-[-3rem] bg-white' src='https://i.postimg.cc/rzMnRBfQ/profile-vander.jpg' alt="Profile Vander" />
              <h2 className='text-2xl font-bold text-center py-8'>Crew</h2>
              <p className='text-center text-4xl font-bold'>Vander Mulya Putra</p>
              <div className='text-center font-medium'>
